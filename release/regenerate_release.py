...
JOBS=[
 ...
 ('analysis/frame_v08/audit_geometry.py',[],True,'FRAME_DELTA_GEOMETRY_PASS'),
 ('analysis/frame_v08/beam_screen.py',[],False,'FRAME_COMPARATIVE_SCREEN_PASS'),
 ('release/build_frame_release.py',[],True,'FRAME_RELEASE_GENERATED'),
