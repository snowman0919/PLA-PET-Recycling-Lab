...
def main():
    ...
    test_suites = [('test_protocol.py', 'protocol_test_results.json', 26), ('test_protocol_boundaries.py', 'protocol_boundary_results.json', 25)]
    test_count = 0
    ...
    archive=REPO/'dist/PPR-HS-R1-S2-TEST-FOUNDATION-20260909-r1.zip';archive.parent.mkdir(exist_ok=True);archive.write_bytes(first)
