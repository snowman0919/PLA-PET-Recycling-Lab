...
OpenModelica 1.27.0과 Modelica Standard Library 4.0.0으로 18 scenario 및 6 sensitivity sweep를 실행했다. Torque hierarchy는 14 < 18 < 22 < 34 < 48 N·m다. Dynamic envelope는 cutter 전달 22.0 N·m, bearing 1.255 kN, chain 0.603 kN, table anchor 0.495 kN이다.
...
- Conditional target: 179,434 KRW ≤180,000 KRW.
- Quote contingency: 20,000 KRW.
- Absolute plan: 199,434 KRW ≤200,000 KRW; 계획 여유 566 KRW.
