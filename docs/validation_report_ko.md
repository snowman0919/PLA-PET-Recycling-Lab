...
- Purge: feed 승인과 waste-path 확인을 분리하고 120 s/verified A13 timestamp tach 32 revolution, stable temperature, no fault, 시각 확인을 요구한다.
...
- Purge revolution은 `ACTUAL_SCREW_TACH_MEASURED_REVOLUTIONS`; tach timeout/mismatch 때 무효다. 80 g/120 g은 measured mass가 아니다.
