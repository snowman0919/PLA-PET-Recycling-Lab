...
|B-Rep topology|active 144, failure 0|`validation/results/solid_topology.json`|
|Print mesh|12 watertight manifold, failure 0|`validation/results/mesh_manifold.json`|
|Slicing|support 포함 968.97 g, 86.0 h; reserve 포함 1,085.25 g|`validation/results/slicer_results.json`|
...
|Dynamic load|22 N·m fuse, 1.255 kN bearing, 0.603 kN chain, 0.495 kN anchor tension|`dynamic_load_envelope.json`|
...
|Budget|179,434 target; 199,434 reserve 포함; 계획 여유 566|`bom/cash_budget.csv`|
