...
|B-Rep topology|active 135, failure 0|`validation/results/solid_topology.json`|
|Print mesh|12 watertight manifold, failure 0|`validation/results/mesh_manifold.json`|
|Slicing|support 포함 994.61 g, 87.9 h; reserve 포함 1,113.96 g|`validation/results/slicer_results.json`|
