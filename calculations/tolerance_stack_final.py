...
def rows() -> list[dict]:
    ...
    feeder = clearance((32.00, 32.05), (31.55, 31.60), 2)
    ...
    return [
        ...
        interface("TS-09", "FD-MET-02 rotor", "FD-MET-01 housing", "radial running clearance", feeder, "mm", ["housing ID 32.00 +0.05/0", "rotor OD 31.60 -0.05/0"], "(housing ID limit − rotor OD opposite limit) / 2", "radial clearance ≥0.20", .20, "running fit", "Ra≤3.2 deburred", "Ø8 shaft and removable collars", "bore gauge + micrometer", "finish-turn rotor", "20–80 °C"),
