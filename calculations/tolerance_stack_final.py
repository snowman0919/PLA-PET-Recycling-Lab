...
def mating_rows(stacks):
    ...
    specs = {
        ...
        "IF-027": ("removed hopper-maintenance PTC", "external predry architecture", "no active mating interface", [evidence("docs/final/release_notes_v1.0.0-rc1_ko.md", "Hopper PTC는 활성 설계에서 제거")], ""),
