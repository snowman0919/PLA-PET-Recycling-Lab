...
7. P6 전체 기계: 디지털 통합과 제작 검토 패키지 생성 완료. 전체 STEP/native FreeCAD, BOM CSV/XLSX, KiCad wiring, host firmware build, nominal DXF/PDF, assembly/service 절차와 hash manifest를 만들었다. 실제 부품 MPN·정격·공차·원가·물리 시험·target firmware는 `OPEN_ACTIONS_KO.md` 조건이 충족될 때까지 HOLD다.
