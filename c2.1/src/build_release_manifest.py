...
def main():
    ...
    # Pin this stage's review package only. C2's numerical products are
    # regenerated by run_study.py in CI; floating-point serialization can
    # differ across hosts while C2's own semantic verifier still passes.
    # Hash-pinning those mutable cross-stage outputs made the C2.1 package
    # spuriously fail after a valid C2 regeneration.
