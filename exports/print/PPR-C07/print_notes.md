...
- support-contact region: 80x32 inspection-window upper edge
- support removal: deburr from open guard interior
- brim: none
- designed minimum wall: 2.0 mm
- estimated mass: 69.3 g/ea, 69.3 g total
- estimated print time: 5.8 h at 12 g/h planning rate
...
- physical interfaces: 4x Ø4.5 through; 80x32 guarded window
- tolerance: 0.40 mm guard gap
- mating part: metal puller plate
- assembly order: 15
- bounding box: 110.0 x 100.0 x 65.0 mm
...
- PrusaSlicer package mass: **80.73 g** for released quantity
- PrusaSlicer package time: **7.31 h**
