...
constexpr uint8_t FEEDER_STEP_PIN = 44;
constexpr uint8_t FEEDER_ENABLE_PIN = 46;
constexpr uint8_t FEEDER_FAULT_PIN = 47;
constexpr uint16_t FEEDER_MOTOR_STEPS_PER_REV = 800;
constexpr uint8_t FEEDER_GEAR_RATIO = 10;
constexpr uint32_t FEEDER_TACH_TIMEOUT_MS = 2000UL;
constexpr uint8_t SHREDDER_LPWM_PIN = 4;
...
constexpr uint8_t EX_CURRENT_PIN = A9;
...
constexpr uint8_t DRIVER_FAULT_PINS[] = {PULLER_FAULT_PIN, SPOOLER_FAULT_PIN, FEEDER_FAULT_PIN};
}
