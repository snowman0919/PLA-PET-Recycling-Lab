...
Compact single-path architecture와 모든 안전 기능을 유지했다. 특정 `MY1016Z` motor, elastomer coupling, 특정 phase gear MPN에 종속하지 않는 DRV-01/DRV-Axx/DRV-F01/DRV-02/DRV-03 functional interface, donor flat stock 우선, 실제 PrusaSlicer 산출량을 반영하여 조건부 target 계획액은 **179,951 KRW**다. 20,000 KRW 견적변동 예비비를 포함한 절대 계획액은 **199,951 KRW**다.
...
|CAD mass allowance|필요 part에 support를 활성화한 PrusaSlicer 2.9.6 toolpath 994.61 g + 실패 reserve 12%|계획 질량 1,113.96 g, 1.5 kg target 이내|
|full cutter/screw 일괄|CUT-01 2장, EX-CPN-SCR/EX-CPN-BAR 최소 coupon 선행|물리 결과 전 full order는 금지|

## Budget hierarchy

- Target total: 179,951 KRW (`CONDITIONAL_TARGET_PASS`, 목표 180,000 이하)
- Quote contingency: 20,000 KRW (기능 추가용이 아님)
- Absolute total: 199,951 KRW (`CONDITIONAL_CAP_PASS`, 절대 200,000 이하; 여유 49 KRW)
- CNC/fabrication target: 76,000 KRW
- 신규 non-CNC/interface/safety target: 72,000 KRW
- Final-machine print planning: 20,051 KRW
