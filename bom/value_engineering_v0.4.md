...
Compact single-path architecture와 모든 안전 기능을 유지했다. 특정 `MY1016Z` motor, elastomer coupling, 특정 phase gear MPN에 종속하지 않는 DRV-01/02/03 functional interface, donor flat stock 우선, 실제 PrusaSlicer 산출량을 반영하여 조건부 target 계획액은 **178,420 KRW**다. 20,000 KRW 견적변동 예비비를 포함한 절대 계획액은 **198,420 KRW**다.
...
|특정 coupling|#35 chain 12T:18T 또는 12T:24T + DRV-02 four-bolt keyed hub|alignment 흡수와 ratio 선택; guard 유지|
|특정 phase gear|generic M3 Z16 face≥18 mm 또는 동일 DXF 3×6 mm laminate|34 N·m allowable 유지; 22 N·m upstream fuse가 먼저 작동|
|새 metal plate|project-lab donor sheet/plate 우선|critical bearing bore만 finish machining|
|CAD mass allowance|PrusaSlicer 2.9.6 실제 toolpath 913.67 g + 실패 reserve 12%|계획 질량 1,023.31 g, 1.5 kg target 이내|
|full cutter/screw 일괄|CUT-01 2장, EX-CPN-SCR/EX-CPN-BAR 최소 coupon 선행|물리 결과 전 full order는 금지|

## Budget hierarchy

- Target total: 178,420 KRW (`CONDITIONAL_TARGET_PASS`, 목표 180,000 이하)
- Quote contingency: 20,000 KRW (기능 추가용이 아님)
- Absolute total: 198,420 KRW (`CONDITIONAL_CAP_PASS`, 절대 200,000 이하)
- CNC/fabrication target: 76,000 KRW
- 신규 non-CNC/interface/safety target: 72,000 KRW
- Final-machine print planning: 18,420 KRW
- Gate-1 test allowance: 12,000 KRW
