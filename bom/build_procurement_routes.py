...
ROUTES = {
    ...
    "EXT-HTR-001": ("Authorized cartridge-heater supplier", "DeviceMart industrial catalog", "FORBIDDEN", "24 V; 2x100 W + 60 W; watt density; sheath; lead temperature; clamp fit"),
    "EXT-SEN-001": ("Industrial pressure/temperature specialist", "DigiKey; DeviceMart for temperature only", "FORBIDDEN", "three hot-zone sensors; calibrated melt pressure 0-20 MPa; cool-bearing channel"),
    ...
    "GAU-SEN-001": ("Authorized optoelectronics distributor", "DeviceMart sensor catalog", "SAMPLE_ONLY", "two linear shadow heads; Arduino-level output; linearity; drift; final U95 <=0.020 mm"),
    "GAU-OPT-001": ("Authorized optoelectronics distributor", "Local optical fixture supplier", "SAMPLE_ONLY", "two LED backlights; aperture edge; ambient rejection; combined U95"),
...
def main() -> None:
    ...
    markdown.extend([
        ...
        "- E-stop, actuator contactor, thermal fuse, heater driver, pressure relief/센서는 AliExpress 구매 금지다. 승인 유통망의 datasheet와 추적 가능한 MPN이 필요하다.",
        "- `PARTIAL_ASSEMBLY`는 BOM 행의 일부만 가격이 잡힌 경우다. 접촉기 본체 가격에는 코일 억제기·보조접점·배선 부속이 없을 수 있다.",
