...
model FullSystemPLA
  extends Systems.FullCoupledSystem(material=1,processState=GeneratedControl.EXTRUSION,formingInitialState=GeneratedControl.FORMING_REQUALIFYING,useQualificationFixture=true,operatorRethreadConfirmationTime=600);
