...
from geometry import make_auger, make_auger_housing, make_base_and_load_cells, make_heat_shield, make_hopper, make_insulation  # noqa: E402
...
def main() -> None:
    ...
    auger, housing = make_auger(p), make_auger_housing(p)
