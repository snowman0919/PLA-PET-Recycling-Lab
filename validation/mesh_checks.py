...
def main():
    ...
    result={"revision":"solid-manifold-openmodelica-v0.4","mesh_count":len(rows),"meshes":rows,"status":"PASS" if len(rows)==12 and all(r["status"]=="PASS" for r in rows) else "FAIL"}
    ...
    print("MESH_WATERTIGHT_MANIFOLD_OK meshes=12")
