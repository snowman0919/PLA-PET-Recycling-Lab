...
def main():
    ...
    result={"revision":"safety-orchestration-closure-v0.6.1","mesh_count":len(rows),"meshes":rows,"tolerance_coupon":coupon,"status":"PASS" if len(rows)==12 and all(r["status"]=="PASS" for r in rows) and coupon["status"]=="PASS" else "FAIL"}
