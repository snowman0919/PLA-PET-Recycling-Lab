...
def main():
 ...
 tools=set(PHYS.glob('analyze_*.py'))|set(PHYS.glob('validate_*_stage_release.py'))|{PHYS/'profile_nesting.py',PHYS/'build_p3_inspection_packet.py',PHYS/'build_p3_firmware_profile.py',PHYS/'validate_p8_firmware_commissioning.py'}
