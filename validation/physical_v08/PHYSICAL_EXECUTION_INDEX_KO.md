...
| P3 | GGM_DRIVE_BENCH | `P3_GGM_BENCH_KO.md` | preflight -> records -> packet/inspector -> `validate_p3_stage_release.py` | `NOT_RUN` |
| P4 | SHREDDER_COUPON | `P4_SHREDDER_COUPON_KO.md` | validated P3 release -> `analyze_p4_records.py` | `NOT_RUN` |
...
| P8 | INSTALLED_MOTOR_DRY_RUN | `P8_INSTALLED_MOTOR_DRY_RUN_KO.md` | `analyze_p8_records.py` | `NOT_RUN` |
