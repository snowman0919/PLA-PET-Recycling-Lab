...
EXPLICIT_FILES = [
    ...
    "cad/generation/generate_interface_catalog.py",
    "bom/bom.csv",
    ...
    "docs/fusion_deferred_policy_v0.6.2.1_ko.md",
    "docs/validation_report_ko.md",
    ...
    "validation/fusion_policy_v0.6.2.1.json",
    "validation/test_fusion_policy_v0621.py",
    "validation/build_release_metadata_v0621.py",
    "validation/results/release_metadata_v0.6.2.1.json",
    ...
    "fusion_worker/scripts/finalize_v0621_handoff_lock.py",
    "fusion_worker/result_validation/validate_fusion_v0621_package.py",
    "validation/fusion_worker_handoff_v0621.py",
    "validation/interface_catalog_checks.py",
...
GENERATION_COMMANDS = [
    ...
    "python3 validation/fusion_worker_handoff_v0621.py",
