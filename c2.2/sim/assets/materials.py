...
MATERIALS = {
    "PC_SHEET": dict(density=1200., process="unfilled PC sheet candidate cut/formed; separate metal throat/strike unmodeled", temperature="PC only with measured cold-zone temperature and independent metal throat; grade, forming, impact qualification HOLD"),
...
def specification(name: str) -> dict:
    ...
    if name in DECISIONS:
        ...
        if name.startswith("FR-2040-") or name.startswith("FR-2020-"):
            ...
            key = "AL_5052"
        elif name in ("HOP-LID_001", "FEED-BUF_001"):
            key = "PC_SHEET"
