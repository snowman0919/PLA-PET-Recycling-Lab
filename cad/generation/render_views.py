...
def render_tool_access(assembly=None):
    assembly = assembly or assembly_objects()
    render([i for i in assembly if i["group"]=="shredder"], ROOT/"renders/review/shredder_fastener_tool_access.png", "Shredder bearing plates / interleaved discs / M6 through-bolts", "right", arrow=True, arrow_target=(1175,230))
...
def main():
    ...
    print("COMPACT_RENDER_GENERATION_OK images=11")
