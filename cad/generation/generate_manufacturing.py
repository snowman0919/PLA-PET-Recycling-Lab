...
2. G1J-10 metal foot 네 개에 최종기용 CUT-03 두 장을 체결한 뒤 CUT-10 seat ring 네 개와 SKF 61905-2RS1 bearing 네 개, CUT-08 retainer 두 장을 조립한다. CUT-10과 압입 tool은 outer ring만 누른다.
3. CUT-05 좌축과 CUT-05R 우축을 넣고 CUT-01 coupon을 축당 한 장만 6.5 mm offset으로 장착한다. Ø25 split collar와 0.25–0.50 mm metal shim으로 axial gap을 맞춘다.
...
5. DRV-03/DRV-03R solid gear를 각 축의 8 mm matched key에 조립하고 optical index로 설치 치면 위상 11.25±1.0°를 확인한다. Hand rotation 20회에서 간섭·shaft 상대 slip이 없어야 한다.
...
고하중 경로는 cutter → metal shaft → 61905/CUT-10/CUT-08 → CUT-03 → G1J-10 → G1J-01 → table이다. Powered 경로는 motor → DRV-Axx/DRV-01/G1J-11 → DRV-F01 → #35 chain/DRV-02 → shaft이며 출력 chute/tray/corner는 하중경로가 아니다.
""",encoding="utf-8")
