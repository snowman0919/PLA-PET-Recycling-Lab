...
def catalog_rows():
    ...
    return [
        ...
        row("IF-024", "EX-DIE-01", "HT-CART-01", "cartridge heater bore", "Ø6.20 H9 through", "heater Ø6.00", "0.20–0.23 mm diametral running fit", "bore +0/+0.030 mm", "heater supplier drawing", "anti-seize + positive axial clamp", "pin gauge + megohmmeter", "full insertion; no loose lead loading"),
        row("IF-025", "EX-BAR zones 1–3", "TEMP-01..03", "barrel thermocouple", "Ø3.2 blind bore target", "Ø3 mineral-insulated K probe", "0.2 mm diametral clearance", "tip within 1.5–2.0 mm of bore wall", "IEC 60584 K-type", "compression screw/washer", "depth gauge + continuity meter", "probe reads barrel metal, not band surface"),
