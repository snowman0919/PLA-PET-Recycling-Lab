...
def build():
    ...
    objects = [
        ...
        add_feature(doc, "GaugeEnclosure", "GAU-ENC-001", make_gauge_enclosure(params), "GAU-CAM-001", "Opaque printed cold enclosure"),
        add_feature(doc, "GaugeOptics", "GAU-OPT-001", make_gauge_optics(params), "GAU-CAM-001", "Camera mirror windows and backlight envelopes"),
