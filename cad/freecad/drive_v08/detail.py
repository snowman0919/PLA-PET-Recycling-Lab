...
def details(items):
    ...
    cap=Part.makeCylinder(23,2,App.Vector(320,411,382),App.Vector(0,1,0)).cut(Part.makeCylinder(9,2,App.Vector(320,411,382),App.Vector(0,1,0)))
    for x in (300,340): cap=cap.cut(Part.makeCylinder(1.7,2,App.Vector(x,411,382),App.Vector(0,1,0)))
    add('GGM_EX_RadialCap',cap,'steel t2; M3 screws')
