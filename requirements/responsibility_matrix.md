# 책임·검증 matrix — solid-manifold-openmodelica-v0.4
...
|Shredder load|baseline torque hierarchy + OpenModelica|18 scenario, 6 sweep, dynamic envelope|Gate-1 torque/current/RPM/chip size|SURROGATE ONLY|
