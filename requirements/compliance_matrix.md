...
| REQ-COST-002 | BLOCKED_EXTERNAL | `bom/cost_rollup.csv`<br>`requirements/responsibility_matrix.md` | `validation/test_bom.py` | Quote-ready CNC packages and actual quotes totaling at or below 100000 KRW | Codex and User |
