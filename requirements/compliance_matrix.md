...
| REQ-FUNC-008 | DESIGN_EVIDENCE | `docs/operation.md`<br>`docs/ui_screens.md`<br>`electronics/protocol/frp1.md`<br>`firmware/arduino_mega/src/ui_core.cpp`<br>`software/raspberry_pi/recycler/supervisor.py` | `firmware/arduino_mega/tests/test_ui_core.cpp`<br>`firmware/arduino_mega/tests/test_sketch_compile.cpp`<br>`software/raspberry_pi/tests/test_pi_core.py` | Physical material-change purge-waste path demonstration | User |
...
| REQ-MECH-002 | DESIGN_EVIDENCE | `docs/design_report_ko.typ`<br>`cad/freecad/full_assembly/generate.py`<br>`requirements/architecture_contract.md`<br>`simulation/architecture/two_tower_contract.json`<br>`simulation/gpu/two_tower_stability_gpu.json` | `validation/test_cad_generation.py`<br>`validation/test_two_tower_contract.py`<br>`validation/test_two_tower_gpu_evidence.py` | Two-tower CAD joint modal anchor pullout mass and center-of-gravity physical validation | Codex and User |
